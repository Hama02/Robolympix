      ...
      <Card
        ...
        >
          <Image
            ...
            src="\public\suiveur.png"
            alt="robolympix"
            height={["200px", "300px"]}
            width="100%"
            objectFit="cover"
          />
          <HStack p={4} spacing={4} align="start"> {/* Change VStack to HStack here */}
          ...
          <CardFooter style={{ justifyContent: "center", alignItems: "center" }}>
            <a href="https://drive.google.com/file/d/1gECYVhySzYKvsXEDzyvOuwohYR-hYXT_/view?fbclid=IwAR2QF5Cyb56odcIYli-2qmivnioYsJnLqntQavGKIMpwM72ShynIlAoUWrg">
              <Button colorScheme="blackAlpha" variant="solid">View More</Button>
            </a>
          </CardFooter>
        </Card>
        <Card
